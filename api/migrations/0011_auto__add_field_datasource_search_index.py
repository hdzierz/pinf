...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataSource.search_index'
        db.add_column(u'api_datasource', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataSource.search_index'
        db.delete_column(u'api_datasource', 'search_index')
