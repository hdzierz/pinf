...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MarkerOb', fields ['kea_id']
        db.create_index(u'api_markerob', ['kea_id'])

        # Adding index on 'MarkerOb', fields ['ebrida_id']
        db.create_index(u'api_markerob', ['ebrida_id'])


    def backwards(self, orm):
        # Removing index on 'MarkerOb', fields ['ebrida_id']
        db.delete_index(u'api_markerob', ['ebrida_id'])

        # Removing index on 'MarkerOb', fields ['kea_id']
        db.delete_index(u'api_markerob', ['kea_id'])
