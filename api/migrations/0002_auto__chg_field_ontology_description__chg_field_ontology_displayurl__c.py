...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ontology.description'
        db.alter_column(u'api_ontology', 'description', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Ontology.displayurl'
        db.alter_column(u'api_ontology', 'displayurl', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

        # Changing field 'Ontology.owner'
        db.alter_column(u'api_ontology', 'owner', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Ontology.description'
        raise RuntimeError("Cannot reverse this migration. 'Ontology.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Ontology.description'
        db.alter_column(u'api_ontology', 'description', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'Ontology.displayurl'
        db.alter_column(u'api_ontology', 'displayurl', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # User chose to not deal with backwards NULL issues for 'Ontology.owner'
        raise RuntimeError("Cannot reverse this migration. 'Ontology.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Ontology.owner'
        db.alter_column(u'api_ontology', 'owner', self.gf('django.db.models.fields.CharField')(max_length=128))
