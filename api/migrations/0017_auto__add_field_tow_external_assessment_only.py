...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tow.external_assessment_only'
        db.add_column(u'api_tow', 'external_assessment_only',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tow.external_assessment_only'
        db.delete_column(u'api_tow', 'external_assessment_only')
