...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrimerOb.tail'
        db.alter_column(u'api_primerob', 'tail', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PrimerOb.primer_type'
        db.alter_column(u'api_primerob', 'primer_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.PrimerType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PrimerOb.tail'
        raise RuntimeError("Cannot reverse this migration. 'PrimerOb.tail' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PrimerOb.tail'
        db.alter_column(u'api_primerob', 'tail', self.gf('django.db.models.fields.CharField')(max_length=255))

        # User chose to not deal with backwards NULL issues for 'PrimerOb.primer_type'
        raise RuntimeError("Cannot reverse this migration. 'PrimerOb.primer_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PrimerOb.primer_type'
        db.alter_column(u'api_primerob', 'primer_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.PrimerType']))
    ...
    models = {
        ...
        u'api.primerob': {
            ...
            'obkeywords': ('django.db.models.fields.TextField', [], {}),
            'ontology': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['api.Ontology']"}),
            'primer_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Primer']"}),
