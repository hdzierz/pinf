...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FishObKV.fishob'
        db.delete_column(u'api_fishobkv', 'fishob_id')

        # Adding field 'FishObKV.parent'
        db.add_column(u'api_fishobkv', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=6211, to=orm['api.FishOb']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FishObKV.fishob'
        db.add_column(u'api_fishobkv', 'fishob',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['api.FishOb']),
                      keep_default=False)

        # Deleting field 'FishObKV.parent'
        db.delete_column(u'api_fishobkv', 'parent_id')
