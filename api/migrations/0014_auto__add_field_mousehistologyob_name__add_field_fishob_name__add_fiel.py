...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MouseHistologyOb.name'
        db.add_column(u'api_mousehistologyob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'FishOb.name'
        db.add_column(u'api_fishob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'GenotypeOb.name'
        db.add_column(u'api_genotypeob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'QuestionnaireOb.name'
        db.add_column(u'api_questionnaireob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'MouseIntakeOb.name'
        db.add_column(u'api_mouseintakeob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Trip.name'
        db.add_column(u'api_trip', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'RawImportOb.name'
        db.add_column(u'api_rawimportob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'EpigeneticsOb.name'
        db.add_column(u'api_epigeneticsob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ProteinGelSpotOb.name'
        db.add_column(u'api_proteingelspotob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'MouseWeightOb.name'
        db.add_column(u'api_mouseweightob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'MouseHistologyV2Ob.name'
        db.add_column(u'api_mousehistologyv2ob', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MouseHistologyOb.name'
        db.delete_column(u'api_mousehistologyob', 'name')

        # Deleting field 'FishOb.name'
        db.delete_column(u'api_fishob', 'name')

        # Deleting field 'GenotypeOb.name'
        db.delete_column(u'api_genotypeob', 'name')

        # Deleting field 'QuestionnaireOb.name'
        db.delete_column(u'api_questionnaireob', 'name')

        # Deleting field 'MouseIntakeOb.name'
        db.delete_column(u'api_mouseintakeob', 'name')

        # Deleting field 'Trip.name'
        db.delete_column(u'api_trip', 'name')

        # Deleting field 'RawImportOb.name'
        db.delete_column(u'api_rawimportob', 'name')

        # Deleting field 'EpigeneticsOb.name'
        db.delete_column(u'api_epigeneticsob', 'name')

        # Deleting field 'ProteinGelSpotOb.name'
        db.delete_column(u'api_proteingelspotob', 'name')

        # Deleting field 'MouseWeightOb.name'
        db.delete_column(u'api_mouseweightob', 'name')

        # Deleting field 'MouseHistologyV2Ob.name'
        db.delete_column(u'api_mousehistologyv2ob', 'name')
