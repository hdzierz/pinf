...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MouseHistologyOb.search_index'
        db.add_column(u'api_mousehistologyob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'FishOb.search_index'
        db.add_column(u'api_fishob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'GenotypeOb.search_index'
        db.add_column(u'api_genotypeob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'QuestionnaireOb.search_index'
        db.add_column(u'api_questionnaireob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'MouseIntakeOb.search_index'
        db.add_column(u'api_mouseintakeob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Trip.search_index'
        db.add_column(u'api_trip', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'RawImportOb.search_index'
        db.add_column(u'api_rawimportob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'EpigeneticsOb.search_index'
        db.add_column(u'api_epigeneticsob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'ProteinGelSpotOb.search_index'
        db.add_column(u'api_proteingelspotob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'MouseWeightOb.search_index'
        db.add_column(u'api_mouseweightob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'MouseHistologyV2Ob.search_index'
        db.add_column(u'api_mousehistologyv2ob', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MouseHistologyOb.search_index'
        db.delete_column(u'api_mousehistologyob', 'search_index')

        # Deleting field 'FishOb.search_index'
        db.delete_column(u'api_fishob', 'search_index')

        # Deleting field 'GenotypeOb.search_index'
        db.delete_column(u'api_genotypeob', 'search_index')

        # Deleting field 'QuestionnaireOb.search_index'
        db.delete_column(u'api_questionnaireob', 'search_index')

        # Deleting field 'MouseIntakeOb.search_index'
        db.delete_column(u'api_mouseintakeob', 'search_index')

        # Deleting field 'Trip.search_index'
        db.delete_column(u'api_trip', 'search_index')

        # Deleting field 'RawImportOb.search_index'
        db.delete_column(u'api_rawimportob', 'search_index')

        # Deleting field 'EpigeneticsOb.search_index'
        db.delete_column(u'api_epigeneticsob', 'search_index')

        # Deleting field 'ProteinGelSpotOb.search_index'
        db.delete_column(u'api_proteingelspotob', 'search_index')

        # Deleting field 'MouseWeightOb.search_index'
        db.delete_column(u'api_mouseweightob', 'search_index')

        # Deleting field 'MouseHistologyV2Ob.search_index'
        db.delete_column(u'api_mousehistologyv2ob', 'search_index')
