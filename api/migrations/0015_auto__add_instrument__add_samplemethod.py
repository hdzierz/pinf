...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_instrument', (
        ...
        db.send_create_signal(u'api', ['Instrument'])

        # Adding model 'SampleMethod'
        db.create_table(u'api_samplemethod', (
            ('name', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=255)),
            ('alias', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=255)),
            ('datasource', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['api.DataSource'])),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
        ...
        db.send_create_signal(u'api', ['SampleMethod'])


    def backwards(self, orm):
        # Deleting model 'Instrument'
        db.delete_table(u'api_instrument')

        # Deleting model 'SampleMethod'
        db.delete_table(u'api_samplemethod')
