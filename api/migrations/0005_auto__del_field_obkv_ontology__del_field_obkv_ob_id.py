...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ObKV.ontology'
        db.delete_column(u'api_obkv', 'ontology_id')

        # Deleting field 'ObKV.ob_id'
        db.delete_column(u'api_obkv', 'ob_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ObKV.ontology'
        raise RuntimeError("Cannot reverse this migration. 'ObKV.ontology' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ObKV.ontology'
        db.add_column(u'api_obkv', 'ontology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Ontology']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ObKV.ob_id'
        raise RuntimeError("Cannot reverse this migration. 'ObKV.ob_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ObKV.ob_id'
        db.add_column(u'api_obkv', 'ob_id',
