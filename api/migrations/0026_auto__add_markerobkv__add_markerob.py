...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarkerObKV'
        db.create_table(u'api_markerobkv', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.MarkerOb'])),
        ))
        db.send_create_signal(u'api', ['MarkerObKV'])

        # Adding model 'MarkerOb'
        db.create_table(u'api_markerob', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('search_index', self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True)),
            ('kea_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ebrida_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('genotype_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('sex', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['MarkerOb'])


    def backwards(self, orm):
        # Deleting model 'MarkerObKV'
        db.delete_table(u'api_markerobkv')

        # Deleting model 'MarkerOb'
        db.delete_table(u'api_markerob')
    ...
    models = {
        ...
        u'api.fishobkv': {
            'Meta': {'object_name': 'FishObKV'},
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.DataSource']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.FishOb']"}),
        ...
        u'api.markerob': {
            'Meta': {'object_name': 'MarkerOb'},
            'createdby': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'createddate': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.DataSource']", 'null': 'True'}),
            'ebrida_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'genotype_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'group': ('django.db.models.fields.CharField', [], {'default': "'NA'", 'max_length': '1024'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kea_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'lastupdatedby': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'lastupdateddate': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'obkeywords': ('django.db.models.fields.TextField', [], {}),
        ...
        u'api.markerobkv': {
            'Meta': {'object_name': 'MarkerObKV'},
            'datasource': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.DataSource']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.MarkerOb']"}),
            'value': ('jsonfield.fields.JSONField', [], {})
        },
        ...
        u'api.primerob': {
            ...
            'obkeywords': ('django.db.models.fields.TextField', [], {}),
            'ontology': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['api.Ontology']"}),
            'primer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Primer']"}),
            'primer_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.PrimerType']", 'null': 'True', 'blank': 'True'}),
            'recordeddate': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
            'sequence': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'statuscode': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'study': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Study']", 'null': 'True'}),
            'tail': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'xreflsid': ('django.db.models.fields.CharField', [], {'max_length': '2048'})
        },
        u'api.primertail': {
