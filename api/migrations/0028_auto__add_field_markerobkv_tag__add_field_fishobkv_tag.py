...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MarkerObKV.tag'
        db.add_column(u'api_markerobkv', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='na', max_length=255),
                      keep_default=False)

        # Adding field 'FishObKV.tag'
        db.add_column(u'api_fishobkv', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='na', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MarkerObKV.tag'
        db.delete_column(u'api_markerobkv', 'tag')

        # Deleting field 'FishObKV.tag'
        db.delete_column(u'api_fishobkv', 'tag')
