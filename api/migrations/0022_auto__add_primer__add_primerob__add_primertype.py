...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'api', ['Primer'])

        # Adding model 'PrimerOb'
        db.create_table(u'api_primerob', (
            ...
            ('search_index', self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True)),
            ('primer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Primer'])),
            ('primer_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.PrimerType'])),
            ('sequence', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('tail', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'api', ['PrimerOb'])

        # Adding model 'PrimerType'
        db.create_table(u'api_primertype', (
            ('name', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=255)),
            ('alias', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=255)),
            ('datasource', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['api.DataSource'])),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
        ...
        db.send_create_signal(u'api', ['PrimerType'])


    def backwards(self, orm):
        # Deleting model 'Primer'
        db.delete_table(u'api_primer')

        # Deleting model 'PrimerOb'
        db.delete_table(u'api_primerob')

        # Deleting model 'PrimerType'
        db.delete_table(u'api_primertype')
    ...
    models = {
        ...
        u'api.primerob': {
            ...
            'primer_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.PrimerType']"}),
            'recordeddate': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
            'sequence': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'statuscode': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'study': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Study']", 'null': 'True'}),
            'tail': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'xreflsid': ('django.db.models.fields.CharField', [], {'max_length': '2048'})
        },
        u'api.primertype': {
