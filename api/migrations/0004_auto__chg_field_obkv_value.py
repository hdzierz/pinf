...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ObKV.value'
        db.alter_column(u'api_obkv', 'value', self.gf('django.db.models.fields.CharField')(max_length=10240))

    def backwards(self, orm):

        # Changing field 'ObKV.value'
        db.alter_column(u'api_obkv', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
