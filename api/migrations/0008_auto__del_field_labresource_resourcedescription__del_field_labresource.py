...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Labresource.resourcedescription'
        db.delete_column(u'api_labresource', 'resourcedescription')

        # Deleting field 'Labresource.resourcetype'
        db.delete_column(u'api_labresource', 'resourcetype')

        # Deleting field 'Labresource.resourcedate'
        db.delete_column(u'api_labresource', 'resourcedate')

        # Deleting field 'Labresource.resourcesequence'
        db.delete_column(u'api_labresource', 'resourcesequence')

        # Deleting field 'Labresource.resourceseqlength'
        db.delete_column(u'api_labresource', 'resourceseqlength')

        # Deleting field 'Labresource.resourcename'
        db.delete_column(u'api_labresource', 'resourcename')

        # Adding field 'Labresource.typ'
        db.add_column(u'api_labresource', 'typ',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Adding field 'Labresource.sequence'
        db.add_column(u'api_labresource', 'sequence',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Labresource.seqlength'
        db.add_column(u'api_labresource', 'seqlength',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Labresource.date'
        db.add_column(u'api_labresource', 'date',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Labresource.resourcedescription'
        raise RuntimeError("Cannot reverse this migration. 'Labresource.resourcedescription' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Labresource.resourcedescription'
        db.add_column(u'api_labresource', 'resourcedescription',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Labresource.resourcetype'
        raise RuntimeError("Cannot reverse this migration. 'Labresource.resourcetype' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Labresource.resourcetype'
        db.add_column(u'api_labresource', 'resourcetype',
                      self.gf('django.db.models.fields.CharField')(max_length=256),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Labresource.resourcedate'
        raise RuntimeError("Cannot reverse this migration. 'Labresource.resourcedate' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Labresource.resourcedate'
        db.add_column(u'api_labresource', 'resourcedate',
                      self.gf('django.db.models.fields.DateField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Labresource.resourcesequence'
        raise RuntimeError("Cannot reverse this migration. 'Labresource.resourcesequence' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Labresource.resourcesequence'
        db.add_column(u'api_labresource', 'resourcesequence',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Labresource.resourceseqlength'
        raise RuntimeError("Cannot reverse this migration. 'Labresource.resourceseqlength' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Labresource.resourceseqlength'
        db.add_column(u'api_labresource', 'resourceseqlength',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Labresource.resourcename'
        raise RuntimeError("Cannot reverse this migration. 'Labresource.resourcename' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Labresource.resourcename'
        db.add_column(u'api_labresource', 'resourcename',
                      self.gf('django.db.models.fields.CharField')(max_length=1024),
                      keep_default=False)

        # Deleting field 'Labresource.typ'
        db.delete_column(u'api_labresource', 'typ')

        # Deleting field 'Labresource.sequence'
        db.delete_column(u'api_labresource', 'sequence')

        # Deleting field 'Labresource.seqlength'
        db.delete_column(u'api_labresource', 'seqlength')

        # Deleting field 'Labresource.date'
        db.delete_column(u'api_labresource', 'date')
