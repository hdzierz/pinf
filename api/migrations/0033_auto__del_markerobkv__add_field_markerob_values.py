...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MarkerOb.values'
        db.add_column(u'api_markerob', 'values',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'api_markerobkv', (
            ...
            ('tag', self.gf('django.db.models.fields.CharField')(default='na', max_length=255)),
        ...
        # Deleting field 'MarkerOb.values'
        db.delete_column(u'api_markerob', 'values')
