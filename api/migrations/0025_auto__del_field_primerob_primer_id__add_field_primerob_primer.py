...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PrimerOb.primer_id'
        db.delete_column(u'api_primerob', 'primer_id_id')

        # Adding field 'PrimerOb.primer'
        db.add_column(u'api_primerob', 'primer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['api.Primer']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PrimerOb.primer_id'
        raise RuntimeError("Cannot reverse this migration. 'PrimerOb.primer_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PrimerOb.primer_id'
        db.add_column(u'api_primerob', 'primer_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Primer']),
                      keep_default=False)

        # Deleting field 'PrimerOb.primer'
        db.delete_column(u'api_primerob', 'primer_id')
