...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Crew.crew_name'
        db.delete_column(u'api_crew', 'crew_name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Crew.crew_name'
        raise RuntimeError("Cannot reverse this migration. 'Crew.crew_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Crew.crew_name'
        db.add_column(u'api_crew', 'crew_name',
