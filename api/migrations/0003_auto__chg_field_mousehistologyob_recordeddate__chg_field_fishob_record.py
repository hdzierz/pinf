...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MouseHistologyOb.recordeddate'
        db.alter_column(u'api_mousehistologyob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'FishOb.recordeddate'
        db.alter_column(u'api_fishob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'GenotypeOb.recordeddate'
        db.alter_column(u'api_genotypeob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'QuestionnaireOb.recordeddate'
        db.alter_column(u'api_questionnaireob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'MouseIntakeOb.recordeddate'
        db.alter_column(u'api_mouseintakeob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Trip.recordeddate'
        db.alter_column(u'api_trip', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'RawImportOb.recordeddate'
        db.alter_column(u'api_rawimportob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'EpigeneticsOb.recordeddate'
        db.alter_column(u'api_epigeneticsob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'ProteinGelSpotOb.recordeddate'
        db.alter_column(u'api_proteingelspotob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'MouseWeightOb.recordeddate'
        db.alter_column(u'api_mouseweightob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'MouseHistologyV2Ob.recordeddate'
        db.alter_column(u'api_mousehistologyv2ob', 'recordeddate', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'MouseHistologyOb.recordeddate'
        db.alter_column(u'api_mousehistologyob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'FishOb.recordeddate'
        db.alter_column(u'api_fishob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'GenotypeOb.recordeddate'
        db.alter_column(u'api_genotypeob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'QuestionnaireOb.recordeddate'
        db.alter_column(u'api_questionnaireob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'MouseIntakeOb.recordeddate'
        db.alter_column(u'api_mouseintakeob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Trip.recordeddate'
        db.alter_column(u'api_trip', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'RawImportOb.recordeddate'
        db.alter_column(u'api_rawimportob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'EpigeneticsOb.recordeddate'
        db.alter_column(u'api_epigeneticsob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'ProteinGelSpotOb.recordeddate'
        db.alter_column(u'api_proteingelspotob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'MouseWeightOb.recordeddate'
        db.alter_column(u'api_mouseweightob', 'recordeddate', self.gf('django.db.models.fields.DateField')())

        # Changing field 'MouseHistologyV2Ob.recordeddate'
        db.alter_column(u'api_mousehistologyv2ob', 'recordeddate', self.gf('django.db.models.fields.DateField')())
