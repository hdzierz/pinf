...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_tow', (
            ...
            ('deleted_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('sample_count', self.gf('django.db.models.fields.IntegerField')()),
            ('sampler', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('sample_method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.SampleMethod'])),
            ('sample_location', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ph_instrument', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True)),
            ('no_comment', self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(default=None, null=True)),
            ('date_on_deck', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
        ))
        db.send_create_signal(u'api', ['Tow'])

        # Adding M2M table for field treatments on 'Tow'
        m2m_table_name = db.shorten_name(u'api_tow_treatments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tow', models.ForeignKey(orm[u'api.tow'], null=False)),
            ('treatment', models.ForeignKey(orm[u'api.treatment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tow_id', 'treatment_id'])

        # Adding M2M table for field instruments on 'Tow'
        m2m_table_name = db.shorten_name(u'api_tow_instruments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tow', models.ForeignKey(orm[u'api.tow'], null=False)),
            ('instrument', models.ForeignKey(orm[u'api.instrument'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tow_id', 'instrument_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'Tow'
        db.delete_table(u'api_tow')

        # Removing M2M table for field treatments on 'Tow'
        db.delete_table(db.shorten_name(u'api_tow_treatments'))

        # Removing M2M table for field instruments on 'Tow'
        db.delete_table(db.shorten_name(u'api_tow_instruments'))
